...
|--------|------|-------------|
| [dns](./infrastructure/aws/dns) | Terraform/OpenTofu | Creates Route53 public and private hosted zones with VPC associations |
| [iam](./infrastructure/aws/iam) | Terraform/OpenTofu | Creates IAM roles with policies and optional instance profiles |
