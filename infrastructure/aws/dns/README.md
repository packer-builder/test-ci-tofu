...
- Outputs zone IDs, ARNs, and name servers for public and private zones

## Usage

```hcl
module "dns" {
  source = "git::https://github.com/packer-builder/test-ci-tofu.git//infrastructure/aws/dns?ref=v1.6.1"
